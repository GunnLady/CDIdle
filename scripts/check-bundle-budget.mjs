...
// portrait manifest. CDI-150 and CDI-152 add per-identity cinema scale corrections;
// 256 KiB covers the CDI-152 URL manifest without changing the per-chunk ceiling.
