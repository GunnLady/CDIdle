...
- Livraison : `src/assets/undercitySmugglersVisualManifest.ts`, `public/assets/images/dungeon/undercity/smugglers/` et `assets/design/dungeon-2d/undercity-smugglers-kit-v1.prompt.md` couvrent les six blueprints et les 14 membres canoniques.
