---
id: CDI-145
title: Refaire les bases Pugiliste selon l’étalon CDIdle
status: Done
area: ui
priority: P1
size: L
...
blocks: ["CDI-119","CDI-125","CDI-134","CDI-135","CDI-157"]
github_issue: null
related_docs: ["docs/development/dungeon-2d-action-production-plan.md","docs/development/dungeon-2d-sprite-audit.md","docs/development/session-2026-09-18-cdi-145-pugilist-sprites-handoff.md","assets/design/hero-sprites/cdi-145/pugilist-identities-and-inspirations.md","assets/design/hero-sprites/cdi-145/handoff.md","assets/design/hero-sprites/human-tier1-class-spritesheets-v1.prompt.md","scripts/prepare-cdi-145-pugilist-assets.ps1","src/assets/pugilistCdi145Portraits.ts","src/assets/heroSpriteSheets.ts","src/domain/heroPortrait.ts","src/assets/heroPortraitAssets.ts","AGENTS.md"]
---

# CDI-145 — Refaire les bases Pugiliste selon l’étalon CDIdle

## Objectif

Remplacer les deux planches Pugiliste par des bases de meilleure qualité et mieux proportionnées, cohérentes avec l’étalon humanoïde CDIdle confirmé.

## Resultat utilisateur

Les vingt identités Pugiliste, dix hommes et dix femmes, proposent des tenues, carnations, coupes, couleurs de cheveux et particularités variées, avec la qualité et la présence des références validées.
...
Ressources historiques : `src/assets/images/hero-sprites/tier1/human-tier1-pugilist-male-v1.png` et `src/assets/images/hero-sprites/tier1/human-tier1-pugilist-female-v1.png`.

## Perimetre autorise

- Refaire les bases neutres masculine et féminine Pugiliste, dix variantes chacune.
...
- [x] Dix hommes et dix femmes Pugiliste sont validés, avec une réattribution stable des index historiques 0–19 vers 0–9 pour le même genre.
...
- Les anciennes clés `0–19` se replient de façon stable vers `0–9` pour le même
  genre ; les vingt Pugilistes chargent sur les cinq pages du vrai cinéma PC,
...
- Les boîtes visibles mesurent `623 px` pour les hommes et `595–596 px` pour les
  ...
  `x = 170`.
- Le script de préparation reproduit les vingt exports bit pour bit : `20/20`
  SHA-256 identiques.
- `npm.cmd run check:dungeon-visuals` : succès ; poids total
  `5 407 431 octets`, quatre plus lourds `1 180 161 octets`, mémoire décodée
  `943 888 octets` par sprite et `3 775 552 octets` pour quatre.
- Tests portraits/visuels : `36/36` ; Playwright ciblé : `1/1` ; typecheck,
