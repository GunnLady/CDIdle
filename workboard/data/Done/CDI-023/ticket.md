...
blocks: ["CDI-024", "CDI-032", "CDI-051"]
github_issue: null
related_docs: ["docs/fullstack-authoritative-plan.md", "docs/architecture/zero-rebase-audit.md"]
---

# CDI-023 — Client Supabase et suppression Firebase

## Objectif

Implementer le perimetre Client Supabase et suppression Firebase selon le plan fullstack autoritaire.
...
Ce ticket depend de : ["CDI-019", "CDI-022"].
