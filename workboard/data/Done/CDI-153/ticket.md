...
# CDI-153 — Produire et intégrer les poses de combat Acolyte

## Objectif

Produire pour les dix hommes et dix femmes Acolyte une pose de combat en garde, cohérente avec leur base neutre, puis l’utiliser comme attente pendant les affrontements du cinéma.

## Resultat utilisateur

Chaque Acolyte conserve exactement son identité et son équipement visuel entre la pose neutre et la garde. Dans le cinéma, le héros passe de la pose neutre à la garde au début de l’affrontement, revient en garde après chaque action et quitte la garde à la fin du combat.
...
- CDI-141 : vingt bases neutres Acolyte validées.
