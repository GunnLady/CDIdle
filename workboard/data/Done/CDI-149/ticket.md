---
id: CDI-149
title: Produire et intégrer les poses de combat Guerrier
status: Done
area: ui
priority: P1
size: L
...
depends_on: ["CDI-137","CDI-148"]
blocks: ["CDI-118","CDI-119","CDI-125","CDI-128","CDI-135"]
github_issue: null
related_docs: ["docs/development/dungeon-2d-action-production-plan.md","docs/development/dungeon-2d-combat-idle-sprite-workflow.md","assets/design/hero-sprites/cdi-149/handoff.md","src/assets/heroSpriteSheets.ts","src/domain/dungeonCombatScene.ts","src/components/dungeon/CurrentEncounterPanel.tsx","AGENTS.md"]
---

# CDI-149 — Produire et intégrer les poses de combat Guerrier

## Objectif

Produire pour les dix hommes et dix femmes Guerrier une pose de combat en garde, cohérente avec leur base neutre, puis l’utiliser comme attente pendant les affrontements du cinéma.

## Resultat utilisateur

Chaque Guerrier conserve exactement son identité et son équipement visuel entre la pose neutre et la garde. Dans le cinéma, le héros passe de la pose neutre à la garde au début de l’affrontement, revient en garde après chaque action et quitte la garde à la fin du combat.
...
- CDI-137 : vingt bases neutres Guerrier validées.
