---
id: CDI-125
title: Animer chants, cris, poudre et renforcements
status: Later
area: ui
priority: P1
size: M
...
depends_on: ["CDI-113","CDI-114","CDI-136","CDI-137","CDI-138","CDI-142","CDI-145","CDI-146","CDI-148","CDI-149","CDI-150","CDI-154","CDI-157"]
blocks: ["CDI-135"]
github_issue: null
...
# CDI-125 — Animer chants, cris, poudre et renforcements

## Objectif

Faire comprendre le type d’action de soutien sans produire un geste unique pour chaque compétence.
...
Lot S2 du plan amélioré. Le socle et les images déjà livrés sont réutilisés. Taille M relative, incluant intégration, contrôles et revue, hors attente visuelle ; pas un engagement de durée ni de production en série. Aucun résultat visuel n’est encore validé pour ce lot.

## Perimetre autorise

inspiring_song, discordant_chord, soothing_song ; weakening_shout, provocation, blinding_dust, guard_stance, battle_focus. Trois recettes sobres : instrument/voix, lancer de poudre, prise de garde/concentration.

## Hors perimetre

- Pas de geste complexe, de nouveau système musical ou de pose obligatoire par compétence.
...
- [ ] Les huit skillId sont couverts, avec geste partagé uniquement quand son sens reste juste.
- [ ] Chant et soin collectifs ne visent que les acteurs reçus ; poudre ne produit pas de dégâts fictifs.
- [ ] Provocation/garde/concentration utilisent les vrais états, durées et cibles, pas un nouvel aggro ou contrôle local.
- [ ] La pose de base est réutilisée si elle suffit, identité et instrument/arme ne changent pas pendant l’action.
...
Les huit skillId, self/single/all, renouvellement/expiration, coûts PM, réception collective et lecteur continu.
