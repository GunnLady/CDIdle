---
id: CDI-130
title: Mettre en scène l’alerte d’embuscade
status: Later
area: ui
priority: P1
size: M
...
# CDI-130 — Mettre en scène l’alerte d’embuscade

## Objectif

Lire une alerte et un évitement ou une surprise sans lancer un nouveau combat.
...
Lot N2 du plan amélioré. Le socle et les images déjà livrés sont réutilisés. Taille M relative, incluant intégration, contrôles et revue, hors attente visuelle ; pas un engagement de durée ni de production en série. Aucun résultat visuel n’est encore validé pour ce lot.

## Perimetre autorise

ambush ; héros choisi, accessoire d’alerte existant, mouvement bref d’attention/esquive ou recul, résultat autoritaire.

## Hors perimetre

- Pas de combat supplémentaire, de nouveau PNJ ni de nouvelle règle d’embuscade.
...
- [ ] Le héros sélectionné réagit au bon instant ; succès et surprise se comprennent.
- [ ] Aucun ennemi ou tour supplémentaire n’est créé ; conséquences fidèles, sans wipe fictif.
...
Deux branches ambush, dommages reçus et absence de commande de combat ; replay.
