---
id: CDI-126
title: Tracer et montrer les intentions et protections ennemies
status: Later
area: ui
priority: P1
size: M
...
depends_on: ["CDI-106","CDI-113","CDI-147"]
blocks: ["CDI-127","CDI-135"]
github_issue: null
...
# CDI-126 — Tracer et montrer les intentions et protections ennemies

## Objectif

Rendre visible la préparation, l’assaut, la protection et l’exposition réellement présentes dans le combat.
...
Lot E1 du plan amélioré. Le socle et les images déjà livrés sont réutilisés. Taille M relative, incluant intégration, contrôles et revue, hors attente visuelle ; pas un engagement de durée ni de production en série. Aucun résultat visuel n’est encore validé pour ce lot.

## Perimetre autorise

Chaîne producteur → trace compatible → projection pure → scène pour cover/surge et gardes/protecteurs. Réutiliser les repères de 113 ; ne pas ajouter de pas logiques pour une intention autrefois filtrée.

## Hors perimetre

- Buffs/debuffs génériques : CDI-114 ; mutation et chorégraphie du Roi : CDI-127.
...
- [ ] Début/changement/fin des intentions et protections sont prouvés au point métier connu et rendus sur les bons acteurs.
- [ ] La mort d’un protecteur fait évoluer la protection à sa vraie condition ; aucune absorption chiffrée ou attaque future inventée.
- [ ] Anciennes traces, persistance/replay, RNG et calendrier de lecture restent compatibles ; octets ajoutés mesurés.
...
Golden domaine, contrats, projection et composants avec protecteur vivant/mort et phases surge ; test:integration et test:egress-budget si trace persistée modifiée.
