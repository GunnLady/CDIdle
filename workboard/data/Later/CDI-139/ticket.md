...
blocks: ["CDI-121","CDI-134","CDI-135"]
github_issue: null
...
Les quarante identités Archer conservent leurs idées de tenue, carnations, coupes, couleurs de cheveux et particularités, avec la qualité et la présence des références validées.
...
Ressources historiques : `src/assets/images/hero-sprites/tier1/human-tier1-archer-male-v1.png` et `src/assets/images/hero-sprites/tier1/human-tier1-archer-female-v1.png`.

## Perimetre autorise

- Refaire les bases masculine et féminine Archer, vingt variantes chacune, à index stable.
...
- [ ] Les quarante index Archer ont une correspondance explicite avec les bases historiques et préservent tenue, carnation, cheveux et particularités.
