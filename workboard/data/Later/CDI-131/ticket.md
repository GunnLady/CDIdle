---
id: CDI-131
title: Mettre en scène l’activation du rituel
status: Later
area: ui
priority: P1
size: M
...
# CDI-131 — Mettre en scène l’activation du rituel

## Objectif

Comprendre une canalisation et son issue autour du dispositif.
...
Lot N3 du plan amélioré. Le socle et les images déjà livrés sont réutilisés. Taille M relative, incluant intégration, contrôles et revue, hors attente visuelle ; pas un engagement de durée ni de production en série. Aucun résultat visuel n’est encore validé pour ce lot.

## Perimetre autorise

ritual ; héros sélectionné, dispositif existant, geste simple de canalisation puis éveil ou retour de force ; ressources et résultat reçus.

## Hors perimetre

- Pas de nouvelle magie métier ni de cycle d’incantation complexe.
...
- [ ] Le dispositif répond au geste, pas à une simple entrée de l’image dans la scène.
- [ ] Réussite et échec restent distincts d’un sort de dégâts et d’un wipe ; aucune ressource inventée.
...
Deux branches ritual, timing geste/dispositif/conséquences, interruption et reduced-motion.
