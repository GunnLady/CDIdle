...
blocks: ["CDI-118","CDI-119","CDI-125","CDI-134","CDI-135"]
github_issue: null
...
Remplacer les deux planches Guerrier par des bases de meilleure qualité et mieux proportionnées, cohérentes avec l’étalon humanoïde CDIdle confirmé.

## Resultat utilisateur

Les quarante identités Guerrier conservent leurs idées de tenue, carnations, coupes, couleurs de cheveux et particularités, avec la qualité et la présence des références validées.
...
Ressources historiques : `src/assets/images/hero-sprites/tier1/human-tier1-warrior-male-v1.png` et `src/assets/images/hero-sprites/tier1/human-tier1-warrior-female-v1.png`.

## Perimetre autorise

- Refaire les bases masculine et féminine Guerrier, vingt variantes chacune, à index stable.
...
- [ ] Les quarante index Guerrier ont une correspondance explicite avec les bases historiques et préservent tenue, carnation, cheveux et particularités.
