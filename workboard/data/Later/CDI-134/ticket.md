---
id: CDI-134
title: Préserver trésor et repos avec les héros retouchés
status: Later
area: ui
priority: P1
size: M
...
depends_on: ["CDI-102","CDI-117","CDI-128","CDI-136","CDI-137","CDI-138","CDI-139","CDI-140","CDI-141","CDI-142","CDI-143","CDI-144","CDI-145"]
blocks: ["CDI-116"]
github_issue: null
...
# CDI-134 — Préserver trésor et repos avec les héros retouchés

## Objectif

Retrouver les compositions validées après les seules retouches artistiques nécessaires.
...
Lot N6 du plan amélioré. Le socle et les images déjà livrés sont réutilisés. Taille M relative, incluant intégration, contrôles et revue, hors attente visuelle ; pas un engagement de durée ni de production en série. Aucun résultat visuel n’est encore validé pour ce lot.

## Perimetre autorise

Réintégration des héros retouchés dans treasure/rest ; coffre, ombre, camp, formations, profondeur et flux de bulles validés restent les références. Réutiliser le relèvement de 128.

## Hors perimetre

- Pas de nouveau background ni de refonte des compositions déjà acceptées.
...
- [ ] Tous les tickets A1 créés après 117 sont des prérequis explicites et terminés ; aucun héros retouché n’est oublié.
- [ ] Coffre/camp, éclairage, ombres et positions validés sont préservés ; pivots et tailles restent stables entre bases/poses.
- [ ] Réanimation et PV/PM suivent le résultat réel ; bulles hors visage sur une ligne, espacées de 600 ms pour 1 000 ms de vie.
...
Treasure/rest avec héros debout/KO, identités retouchées, ressources partielles/plafonnées et catalogue réel.
...
- Écart différé au 13 septembre 2026 : deux bulles de récupération d’un même héros se chevauchent encore d’environ 4 px à 750 ms aux largeurs PC 1024/1280/1440. La clôture exige le passage des trois scénarios `keeps treasure and rest scenes composed`.
