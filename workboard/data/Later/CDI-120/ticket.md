---
id: CDI-120
title: Donner aux créatures des attaques adaptées à leur corps
status: Later
area: ui
priority: P1
size: M
...
# CDI-120 — Donner aux créatures des attaques adaptées à leur corps

## Objectif

Distinguer morsure, pince et attaque de slime sans faire glisser toutes les créatures comme des épéistes.
...
Lot C3 du plan amélioré. Le socle et les images déjà livrés sont réutilisés. Taille M relative, incluant intégration, contrôles et revue, hors attente visuelle ; pas un engagement de durée ni de production en série. Aucun résultat visuel n’est encore validé pour ce lot.

## Perimetre autorise

Pilotes nommés : rat-pack, crabe des vannes (water-parasites/valve-sentinel), pipe-slime. Compression/extension modérée et mouvement d’appui ; exceptions de morphologie inscrites au manifeste, déclinaison par écran via A2.

## Hors perimetre

- Pas de régénération du bestiaire entier ni de copie d’une animation humaine sur toutes les espèces.
...
- [ ] Rat et crabe n’émettent pas un slash d’arme humaine ; geste et impact restent lisibles avec le sprite réutilisé.
- [ ] Le slime conserve silhouette/visage validés, appui et ombre ; aucun redessin de skin imposé.
- [ ] Les images partagées sont contrôlées sur leurs autres écrans ; chaque exception actuelle reçoit un ticket bloquant CDI-135.
...
Mapping des clés de contenu, morphologies petite/grande, ancrage au sol, KO et attente après action.
