...
depends_on: ["CDI-139","CDI-148"]
blocks: ["CDI-121","CDI-128","CDI-135"]
github_issue: null
...
# CDI-151 — Produire et intégrer les poses de combat Archer

## Objectif

Produire pour les dix hommes et dix femmes Archer une pose de combat en garde, cohérente avec leur base neutre, puis l’utiliser comme attente pendant les affrontements du cinéma.

## Resultat utilisateur

Chaque Archer conserve exactement son identité et son équipement visuel entre la pose neutre et la garde. Dans le cinéma, le héros passe de la pose neutre à la garde au début de l’affrontement, revient en garde après chaque action et quitte la garde à la fin du combat.
...
- CDI-139 : vingt bases neutres Archer validées.
