---
id: CDI-133
title: Mettre en scène l’échange de négociation
status: Later
area: ui
priority: P1
size: M
...
# CDI-133 — Mettre en scène l’échange de négociation

## Objectif

Comprendre une offre puis son acceptation ou refus, avec les bons montants.
...
Lot N5 du plan amélioré. Le socle et les images déjà livrés sont réutilisés. Taille M relative, incluant intégration, contrôles et revue, hors attente visuelle ; pas un engagement de durée ni de production en série. Aucun résultat visuel n’est encore validé pour ce lot.

## Perimetre autorise

negotiation ; héros sélectionné, objets/table existants, geste d’offre/dialogue bref puis résultat ; or reçu/perdu ou absence de variation.

## Hors perimetre

- Pas de PNJ interactif, de choix de dialogue, de mini-jeu ou de récompense animée calculée localement.
...
- [ ] Offre, acceptation/refus et résultat se lisent sans uniquement faire apparaître la table.
- [ ] Montants exacts, une ligne par information, pas de wipe fictif ni de clic nécessaire pour avancer.
...
Deux branches negotiation, montant nul/positif/perte et aucune mutation depuis le geste.
