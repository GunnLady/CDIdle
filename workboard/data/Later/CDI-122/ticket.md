---
id: CDI-122
title: Distinguer les projectiles de feu, glace et foudre
status: Later
area: ui
priority: P1
size: M
...
depends_on: ["CDI-113","CDI-140","CDI-152"]
blocks: ["CDI-123","CDI-135"]
github_issue: null
...
# CDI-122 — Distinguer les projectiles de feu, glace et foudre

## Objectif

Identifier trois sorts offensifs sobres avec un geste de lancement partagé quand il suffit.
...
Lot M1 du plan amélioré. Le socle et les images déjà livrés sont réutilisés. Taille M relative, incluant intégration, contrôles et revue, hors attente visuelle ; pas un engagement de durée ni de production en série. Aucun résultat visuel n’est encore validé pour ce lot.

## Perimetre autorise

fire_bolt, ice_shard, lightning_bolt ; préparation, émission, trajet et impact. Donner une silhouette lisible à chaque élément avec primitives existantes avant de demander des images.

## Hors perimetre

- Pas de pose par élément, de spritesheets complètes ou de moteur de particules ajouté sans nécessité.
...
- [ ] Feu, glace et foudre se distinguent autrement que par un orbe recoloré, sans excès de particules.
- [ ] Source, ancrage, cible et instant d’impact restent fidèles ; la pose existante est conservée si le geste se comprend.
- [ ] Retour à l’attente, coût PM au lancement et conséquences PV sont cohérents en lecture continue.
...
Les trois sorts, dommages létaux/non létaux, interruption/onglet masqué, ancienne trace et reduced-motion.
