---
id: CDI-129
title: Mettre en scène l’énigme et son contrecoup
status: Later
area: ui
priority: P1
size: M
...
# CDI-129 — Mettre en scène l’énigme et son contrecoup

## Objectif

Lire une observation/manipulation puis une résolution ou un contrecoup.
...
Lot N1 du plan amélioré. Le socle et les images déjà livrés sont réutilisés. Taille M relative, incluant intégration, contrôles et revue, hors attente visuelle ; pas un engagement de durée ni de production en série. Aucun résultat visuel n’est encore validé pour ce lot.

## Perimetre autorise

enigma ; héros de challenge.hero_selected, dispositif existant, observation puis activation ou retour de force ; conséquences de mana/ressources reçues.

## Hors perimetre

- Pas de mini-jeu, de jet client ou de pose neuve si un geste simple suffit.
...
- [ ] Le bon héros intervient sur le dispositif, pas seulement à son apparition.
- [ ] Succès et échec sont distincts ; les pertes/gains réels ont une bulle autonome et aucune fausse défaite de groupe.
...
Deux branches enigma, conséquences individuelles/collectives reçues et reduced-motion.
