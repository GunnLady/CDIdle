...
export default function AssignmentPanel({ view, canMutate, onAllocate }: { view: CityDashboardView; canMutate: boolean; onAllocate: (role: CityJobId, amount: number) => void }) {
  return <Panel title="Affectations" subtitle="Citoyens libres et répartition des rôles de production." testId="assignment-panel" className="order-3 xl:col-start-3 xl:row-start-1" contentClassName="space-y-4">
    <Progress
