...
export default function SyncStatusPanel(props: { isSyncing: boolean; isCommandPending: boolean; canRefresh: boolean; blockReason?: string; onSaveCloud: () => Promise<void> }) {
