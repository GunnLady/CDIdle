  ...
  return <AccountPanelFrame title="Identité et session" subtitle="Compte actuellement lié au royaume" testId="account-identity-panel">
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0"><span className="block text-[9px] font-bold uppercase tracking-widest text-emerald-400">Compte connecté</span><strong className="block truncate font-serif text-xs text-[#dfdbc7]">{props.email}</strong></div>
      </div>
