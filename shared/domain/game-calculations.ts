...
export const getRandomNoviceWeapon = (rng: Rng): WeaponItemInfo | null => {
...
export const getRandomNoviceArmor = (rng: Rng): ArmorItemInfo | null => {
...
export const generateNoviceStarterEquipment = (rng: Rng, instanceScope = "local-preview"): HeroEquipment => {
...
export const generateSingleNoviceHero = (unlockedRaces: string[], rng: Rng): Hero => {
...
export function rollWeaponDamage(weapon: WeaponItemInfo | null, rng: Rng): number {
  if (!weapon) {
