...
Seuls les fichiers dont le nom se termine par `-audit.md` sont référencés ici :
...
Ce fichier ne répète pas les sujets déjà traités. Il sert uniquement d’index des
audits qui contiennent encore des écarts, des décisions à prendre ou des idées
de tickets additionnels.
