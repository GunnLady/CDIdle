  ...
  it("round-trips every pending frontend state and dungeon loot through the cache", async () => {
    ...
    const state = {
      ...
      pendingForge: {
        ...
        offeredRarity: "uncommon" as const,
      },
      pendingRecruit,
      ...
      encounterHistory: [{
        ...
        rewards: { gold: 5, loot: [
          { type: "item" as const, instanceId: "loot-item", itemId: "starter_sword", itemLevel: 1, powerModelId: "legacy-fixed-v1" as const, rarity: "common" as const, count: 1 },
